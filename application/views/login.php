...
<div class="login-box">
  <div class="login-logo">
    <center><img src="<?= base_url() ?>assets/img/logo-damkar.png" class="animated flipInY img-responsive" alt="Image" style="width: 50%;"></center>
    <a href="<?= base_url() ?>login"><b>Arsip Surat Damkar Bantul</b></a>
  </div>
