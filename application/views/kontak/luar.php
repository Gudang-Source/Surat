    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          <a href="kontak_luar/tambah" class="btn btn-primary" data-toggle="tooltip"
            title="klik untuk tambah data baru"><i class="fa fa-plus"></i> Tambah Kontak</a>
          <button type="button" class="btn btn-primary" data-toggle="tooltip" title="klik untuk memulai export"><i
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <a title="Klik untuk memulai edit kontak" href="kontak_luar/edit/<?= $d->id_kontak ?>"
